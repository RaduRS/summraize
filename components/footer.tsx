        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 py-8 px-6">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <p className="text-sm text-muted-foreground mt-4">
              © {currentYear} Summr<span className="text-primary">ai</span>ze.
              All rights reserved.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <div className="flex flex-col items-center md:items-start space-y-3">
              ...
              <p className="text-xs text-muted-foreground max-w-xs">
                Summr<span className="text-primary">ai</span>ze converts speech
                and documents to text, summarizes content, and brings it to life
                with AI voice. Pay as you go with our credit system.
              </p>
