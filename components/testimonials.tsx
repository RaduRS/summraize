      ...
      <div className="relative w-full max-w-[2000px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
          {testimonials.map((testimonial, index) => (
            ...
            >
              <Card className="p-6 h-full flex flex-col bg-white dark:bg-gray-900">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <testimonial.icon className="h-5 w-5 text-purple-600 dark:text-purple-400 ml-auto" />
                </div>
                <blockquote className="text-gray-600 dark:text-gray-300 flex-1">
                  "{testimonial.quote}"
                </blockquote>
